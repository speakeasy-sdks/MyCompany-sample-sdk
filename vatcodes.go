...
// GetVatCodes - Gets the vat codes on the client. (Auth roles: CommonServices,CommonServices_Full)
...
func (s *VatCodes) GetVatCodes(ctx context.Context, request operations.GetVatCodesRequest) (*operations.GetVatCodesResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "get_/VatCodes"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/VatCodes")
	if err != nil {
	...
	res := &operations.GetVatCodesResponse{
