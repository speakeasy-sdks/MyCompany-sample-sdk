...
// GetCurrencies - Gets the currencies set on the client. (Auth roles: CommonServices,CommonServices_Full)
...
func (s *Currencies) GetCurrencies(ctx context.Context, request operations.GetCurrenciesRequest) (*operations.GetCurrenciesResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "get_/Currencies"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/Currencies")
	if err != nil {
